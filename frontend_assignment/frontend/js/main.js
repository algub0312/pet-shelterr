...
function createPetCard(pet) {
    ...
    const badge = pet.medical.special_needs ? window.i18n.t('pet_card.special_needs') :  //daca are nevoi speciale apare badgeul
        isNewArrival(pet.arrival_date) ? window.i18n.t('pet_card.new_arrival') : ''; //else daca e nou afiseaza new arrival
    //else fara badge
    ...
    card.innerHTML = `
        ...
        <div class="pet-info">
            ...
            <a href="pet-detail.html?id=${pet.id}" class="btn btn-small">${window.i18n.t('pet_card.meet_button', { name: pet.name })}</a>
        </div>
    `;

...
async function initializePetsPage() {
    try {
        ...
        showError(window.i18n.t('search.error_message'));
    }
}
...
function createPetCard(pet) {
    ...
    const badge = hasSpecialNeeds ? window.i18n.t('pet_card.special_needs') :
        isNewArrival ? window.i18n.t('pet_card.new_arrival') : '';
